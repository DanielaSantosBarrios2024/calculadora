...
const calc =() => {
  ...
  <div class="container">
    <h1 class="title">React Calculadora uwu</h1>
    <div class="calculator">
      <input type="text" class ="calc-numbers" 
      value ={result}/>
      <div class ="calculator-buttons">
        <button onClick={clear}class="btn clear span-2">C</button>
        <button onClick={backspace} class="btn orange">&larr;</button>
        <button onClick={handleClick} name="/"class="btn orange">&divide;</button>
        ...
        <button onClick={handleClick} name="*" class="btn orange">x</button>
        ...
        <button onClick={handleClick} name="+" class="btn orange">+</button>
        <button onClick={handleClick} name="0"class="btn span-3">0</button>
        <button onClick={calc}class="btn orange equal">=</button>
      </div>
    </div>
  </div>  
  )
